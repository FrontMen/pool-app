...
// Types
var Leaderboard_1 = __webpack_require__(16);
var Game_1 = __webpack_require__(6);
var Player_1 = __webpack_require__(17);
var Login_1 = __webpack_require__(18);
var Layout_1 = __webpack_require__(19);
var NewPlayerForm_1 = __webpack_require__(5);
var Messages_1 = __webpack_require__(7);
var filter_1 = __webpack_require__(4);
var competitions;
(function (competitions) {
    competitions["overall"] = "overall";
    competitions["frontmen"] = "frontmen";
    competitions["jpoint"] = "jpoint";
})(competitions = exports.competitions || (exports.competitions = {}));
var initialState = {
    players: [],
...
var actions = {
    ...
    setFilter: filter_1.setFilter,
    game: {
        gameFormChange: Game_1.gameFormChange,
        gameFormSubmit: Game_1.gameFormSubmit,
    },
    newUser: {
        formChange: NewPlayerForm_1.formChange,
        formSubmit: NewPlayerForm_1.formSubmit,
    },
    setMessage: Messages_1.setMessage,
    removeMessage: Messages_1.removeMessage,
    login: Login_1.login,
...
var view = function (state) { return function (actions) {
    ...
    switch (state.view.name) {
        ...
        case 'overview':
        default:
            return Layout_1.LayoutMixin(Leaderboard_1.Leaderboard({ state: state, actions: actions }), defaultLayoutActions);
    }
}; };
// Views & Actions
...
Object.defineProperty(exports, "__esModule", { value: true });
var hyperapp_1 = __webpack_require__(0);
exports.setFilter = function (filter) { return ({ filter: filter }); };
exports.Filter = function (_a) {
    var options = _a.options, selected = _a.selected, setFilter = _a.setFilter;
    return (hyperapp_1.h("div", { class: "filters" }, options.map(function (option) { return (hyperapp_1.h(FilterOption, { option: option, selected: option === selected, setFilter: function () { return setFilter(option); } })); })));
};
var FilterOption = function (_a) {
    var option = _a.option, selected = _a.selected, setFilter = _a.setFilter;
    return (hyperapp_1.h("div", { key: option, onclick: setFilter, class: "filters__item " + (selected ? 'filters__item--active' : '') }, option));
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var hyperapp_1 = __webpack_require__(0);
exports.NewPlayerForm = function (newUserFormChange, newUserFormSubmit, newUser, toggleShowNewPlayer) { return (hyperapp_1.h("div", { id: "newPLayerForm" },
    hyperapp_1.h("h3", null, "Nieuwe speler"),
    ",",
    hyperapp_1.h("form", { onchange: newUserFormChange, onsubmit: function (e) {
            e.preventDefault();
            newUserFormSubmit(newUser);
        } },
        hyperapp_1.h("div", { className: "form-group" },
            hyperapp_1.h("label", { for: "name" }, "Naam"),
            hyperapp_1.h("input", { id: "name", placeholder: "Jan", name: "name", class: "form-control" })),
        hyperapp_1.h("div", { className: "form-group" },
            hyperapp_1.h("label", { for: "email" }, "Email"),
            hyperapp_1.h("input", { id: "email", placeholder: "jan@doe.nl", name: "email", class: "form-control" })),
        hyperapp_1.h("div", { class: "form-group" },
            hyperapp_1.h("input", { type: "submit", disabled: newUser.name.length === 0 && newUser.email.length === 0, value: newUser.name.length === 0 ? 'Nieuw' : newUser.name + ' toevoegen!', class: "btn btn-block btn-xs btn-primary" }),
            hyperapp_1.h("input", { type: "button", value: "Cancel", class: "btn btn-block btn-xs", onclick: toggleShowNewPlayer }))))); };
exports.formChange = function (payload) {
    return {
        newUser: {
...
exports.formSubmit = function (_a) {
    var name = _a.name, email = _a.email;
    return function (state) { return function (actions) {
        fetch('/users', {
            method: 'POST',
...
exports.Game = function (_a) {
    var players = _a.players, player = _a.player, gameFormChange = _a.gameFormChange, game = _a.game, gameFormSubmit = _a.gameFormSubmit, setMessage = _a.setMessage;
        ...
        hyperapp_1.h("div", { class: "col-sm" },
            hyperapp_1.h("form", { onchange: gameFormChange, onsubmit: function (e) {
                ...
                hyperapp_1.h("div", { class: "form-group" },
                    ...
                    hyperapp_1.h("input", { type: "text", id: "playerSelect", class: "form-control", name: "player", value: player.name, disabled: true })),
                hyperapp_1.h("div", { class: "btn-group btn-block", "data-toggle": "buttons" },
                    hyperapp_1.h(FancyRadio, { name: "win", value: "win", label: "wint van", radioValue: game.win ? 'win' : 'loose' }),
                    hyperapp_1.h(FancyRadio, { name: "win", value: "loose", label: "verliest van", radioValue: game.win ? 'win' : 'loose' })),
                hyperapp_1.h("div", { class: "form-group" },
                ...
                hyperapp_1.h("div", { class: "form-group" },
                    hyperapp_1.h("input", { type: "submit", value: "play!", class: "btn btn-block btn-primary" }))))));
};
...
exports.gameFormSubmit = function (game) { return function (state) { return function (actions) {
    fetch('game/', {
        method: 'POST',
...
exports.gameFormChange = function (payload) {
    return {
        game: {
...
Object.defineProperty(exports, "__esModule", { value: true });
var hyperapp_1 = __webpack_require__(0);
exports.setMessage = function (message) { return function (state) { return function (actions) {
    setTimeout(function () {
        actions.removeMessage(message);
    }, 5000);
    return { messages: state.messages.concat([message]) };
}; }; };
exports.removeMessage = function (message) { return function (state) { return ({
...
exports.Leaderboard = function (_a) {
    var state = _a.state, actions = _a.actions;
    return (hyperapp_1.h("div", { class: "row", oncreate: actions.fetchGames },
        hyperapp_1.h("div", { class: "col-12" },
            hyperapp_1.h("div", { class: "header" },
                hyperapp_1.h("h1", { class: "header__title" }, "leaderboard"),
                hyperapp_1.h("div", { class: "profile" },
                    hyperapp_1.h("div", { class: "profile__text" },
                        hyperapp_1.h("span", null, "2"),
                        "th"),
                    hyperapp_1.h("div", { class: "profile__text" },
                        hyperapp_1.h("img", { class: "profile__icon", src: "https://robohash.org/" + state.user.name })),
                    hyperapp_1.h("div", { class: "profile__text" },
                        hyperapp_1.h("span", null, state.user.score || 1500),
                        "pt"))),
            hyperapp_1.h(filter_1.Filter, { options: state.competitions, selected: state.filter, setFilter: actions.setFilter }),
            hyperapp_1.h(exports.List, { players: getPlayersByFilter(state.players, state.filter), newUser: state.newUser, newUserFormChange: actions.newUser.formChange, newUserFormSubmit: actions.newUser.formSubmit, setView: actions.setView, showNewPlayer: state.showNewPlayer, toggleShowNewPlayer: actions.toggleShowNewPlayer, user: state.user }))));
};
var getPlayersByFilter = function (players, filter) {
    return filter === index_1.competitions.overall
        ? players
        : players.filter(function (p) { return p.email.indexOf(filter) > -1; });
};
exports.List = function (_a) {
    var players = _a.players, newUser = _a.newUser, user = _a.user, newUserFormChange = _a.newUserFormChange, newUserFormSubmit = _a.newUserFormSubmit, setView = _a.setView, showNewPlayer = _a.showNewPlayer, toggleShowNewPlayer = _a.toggleShowNewPlayer;
    if (players.length === 0) {
        return hyperapp_1.h("p", null, "Geen spelers gevonden in deze competitie");
    }
    return (hyperapp_1.h("ul", { class: "list-group" }, showNewPlayer ? (NewPlayerForm_1.NewPlayerForm(newUserFormChange, newUserFormSubmit, newUser, toggleShowNewPlayer)) : (hyperapp_1.h("div", { class: "list" },
        players.map(function (p, idx) {
            var playerClass = "list__item " + (p._id === user._id &&
                'list__item--active');
            return (hyperapp_1.h("div", { onclick: function (e) {
                    setView({ name: 'player', payload: p._id });
                }, class: playerClass },
                hyperapp_1.h("span", { class: "list__text" }, idx + 1),
                hyperapp_1.h("img", { class: "profile__icon profile__icon--small", src: "https://robohash.org/" + p.name }),
                hyperapp_1.h("span", { class: "list__text list__text--regular" }, p.name),
                hyperapp_1.h("span", { class: "list__text" }, p.score)));
        }),
        hyperapp_1.h("input", { type: "button", value: "Nieuwe speler", class: "btn btn-block btn-xs", onclick: toggleShowNewPlayer })))));
};
...
exports.Player = function (_a) {
    var state = _a.state, actions = _a.actions, player = _a.player;
    var players = state.players, view = state.view, user = state.user;
    var setView = actions.setView, setMessage = actions.setMessage, game = actions.game;
    return (hyperapp_1.h("div", null,
        hyperapp_1.h("div", { class: "row" },
            hyperapp_1.h("div", { class: "col-12" },
                hyperapp_1.h("div", { class: "text-center" },
                    hyperapp_1.h("img", { src: "https://robohash.org/" + player.name, class: "rounded", alt: player.name })),
                hyperapp_1.h("h3", { class: "text-center" },
                    capitalizeFirstLetter(player.name),
                    ' ',
                    hyperapp_1.h("span", { class: "badge badge-warning" }, player.score)),
        ...
        state.user._id !== view.payload &&
            Game_1.Game({
                players: players,
                player: lodash_1.find(players, { _id: state.view.payload }),
...
exports.LoginView = function (_a) {
    var setView = _a.setView, setEmailValue = _a.setEmailValue, login = _a.login, register = _a.register, setMessage = _a.setMessage;
    return (hyperapp_1.h("div", { class: "row" },
        hyperapp_1.h("div", { class: "col-12" },
            hyperapp_1.h("h3", null, "Login"),
            hyperapp_1.h("form", { onsubmit: function (e) {
                    e.preventDefault();
                ...
                hyperapp_1.h("div", { class: "form-group" },
                    hyperapp_1.h("label", { for: "email" }, "Email"),
                    hyperapp_1.h("input", { placeholder: "me@domain.com", id: "email", name: "name", type: "text", class: "form-control", onkeyup: setEmailValue })),
                hyperapp_1.h("div", { class: "form-group" },
                    hyperapp_1.h("label", { for: "password" }, "Token"),
                    hyperapp_1.h("input", { id: "token", name: "token", type: "text", placeholder: "928374", class: "form-control" })),
                hyperapp_1.h("div", { class: "form-group" },
                    hyperapp_1.h("div", { className: "row" },
                        hyperapp_1.h("div", { className: "col-6" },
                            hyperapp_1.h("input", { type: "submit", value: "Login", class: "btn btn-block btn-primary" })),
                        hyperapp_1.h("div", { className: "col-6" },
                            hyperapp_1.h("input", { type: "button", value: "Register", class: "btn btn-block btn-secondary", onclick: function (e) {
                                    e.preventDefault();
                                    register(e);
                                } }))))))));
};
exports.login = function (_a) {
    ...
    return function (state) { return function (actions) {
        fetch('/authenticate', {
            ...
            .catch(function (err) { return actions.setMessage('Login incorrect'); });
    }; };
};
exports.setEmailValue = function (el) { return ({
    login: {
        email: el.target.value.toLowerCase(),
    },
}); };
exports.register = function () { return function (state) { return function (actions) {
    fetch('/users', {
        method: 'POST',
        body: JSON.stringify({
        ...
        .then(function (r) {
        if (r.length === 24) {
            actions.setMessage("You've been registered. You'll receive an email shortly");
        }
        else {
            actions.setMessage('Login incorrect');
        }
